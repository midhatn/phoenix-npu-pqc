...
The harness requires both native hardware runners
(`phoenix_sdr_dsp.silicon.m33{a,b}_runner`). A missing MLIR-AIE/IRON runtime
is an explicit nonzero result; it never selects a reference-Python fallback.
