...
BACKEND_LABEL = "dr15-mldsa87-sign:silicon"
KERNEL_REL_PATH = "phoenix_sdr_dsp/pqc/kernels/dr15_mldsa87_sign_w2_fin.cc"
...
class NativeBackendUnavailable(RuntimeError):
    """The native IRON/XRT DR15 Sign backend is unavailable or failed closed."""
...
def get_kernel_artifact_info(repo_root: Path | None = None) -> dict[str, Any]:
    """Return verified path and SHA-256 digest of the DR15 Sign AIE2 kernel source."""
