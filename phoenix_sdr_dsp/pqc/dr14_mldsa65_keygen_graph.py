...
BACKEND_LABEL = "dr14-mldsa65-keygen:silicon"
KERNEL_REL_PATH = "phoenix_sdr_dsp/pqc/kernels/dr14_mldsa65_keygen_finalize.cc"
...
class NativeBackendUnavailable(RuntimeError):
    """The native IRON/XRT DR14 KeyGen backend is unavailable or failed closed."""
...
def get_kernel_artifact_info(repo_root: Path | None = None) -> dict[str, Any]:
    """Return verified path and SHA-256 digest of the DR14 KeyGen AIE2 kernel source."""
